...
// Arrays to store data for the histogram
$countries = [];
$ratios = [];
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if ($row["Density"] != 0) {
            $densityDisasterRatio = $row["Density"] /  $row["TotalDisasters"];
            $ratios[] = round($densityDisasterRatio, 2);
        } else {
            $ratios[] = "N/A";
        }
    }
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container">
                    <h1 class="mt-5">Density-to-Disaster Histogram</h1>
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                labels: countries,
                datasets: [{
                    label: 'Density-to-Disaster Ratio',
                    data: ratios,
            ...
            options: {
                scales: {
                    ...
                    yAxes: [{
                        scaleLabel: {
                            display: true,
                            labelString: 'Density-to-Disaster'
                        },
                        ticks: {
                            beginAtZero: true
                        }
